...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Send to Backend to Sync/Create User
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 px-6 rounded-lg transition-all duration-200 flex justify-center items-center gap-2 shadow-lg shadow-teal-600/20"
            >
